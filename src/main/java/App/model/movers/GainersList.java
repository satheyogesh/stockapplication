...
* @param latestUpdate
*/
public GainersList(String symbol, String companyName, String primaryExchange, String sector, String calculationPrice, Double open, Long openTime, Double close, Long closeTime, Double high, Double low, Double latestPrice, String latestSource, String latestTime, Long latestUpdate, Long latestVolume, Double iexRealtimePrice, Long iexRealtimeSize, Long iexLastUpdated, Double delayedPrice, Long delayedPriceTime, Double extendedPrice, Long extendedChange, Double extendedChangePercent, Long extendedPriceTime, Double previousClose, Double change, Double changePercent, Double iexMarketPercent, Long iexVolume, Long avgTotalVolume, Long iexBidPrice, Long iexBidSize, Long iexAskPrice, Long iexAskSize, Long marketCap, Object peRatio, Double week52High, Double week52Low, Double ytdChange) {
super();
this.symbol = symbol;
...
public Double getExtendedChangePercent() {
	if(this.extendedChangePercent !=null)
	{
		return new CommonUtil().get2DecimalNumbers( (extendedChangePercent * 100));
	}
	else
	{
		return 0.00;
...
return new CommonUtil().get2DecimalNumbers(changePercent * 100);
}
