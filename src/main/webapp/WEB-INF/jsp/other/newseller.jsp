...
<body>
						...
						<tbody>
							<c:forEach var="sellerList" items="${sellerList}">
								<tr>
									...
									<td><a href="updateseller?id=${sellerList.id}"><span
											class="glyphicon glyphicon-pencil"></span></a></td>
									<td><a href="deleteseller?id=${sellerList.id}"><span
 ...
 --%>
					...
					<!-- 					</div> -->
					<div class="form-group">
						<label>Seller Name:</label> <input type="text"
							class="form-control" placeholder="Enter seller Name"
							name="sellerName" value="${sellerobj.sellerName}">
					</div>
					<div class="form-group">
						<label>Contact Person First Name:</label> <input type="text"
							class="form-control"
							placeholder="Enter Contact Person First Name" name="firstName"
							value="${sellerobj.firstName}">
					</div>
					<div class="form-group">
						<label>Contact Person Last Name:</label> <input type="text"
							class="form-control" placeholder="Enter Contact Person Last Name"
							name="lastName" value="${sellerobj.lastName}">
					</div>
					<div class="form-group">
						<label>Address 1 :</label> <input type="text"
							class="form-control" placeholder="Enter Address 1"
							name="address1" value="${sellerobj.address1}">
					</div>
					<div class="form-group">
						<label>Address 2 :</label> <input type="text"
							class="form-control" placeholder="Enter Address 2"
							name="address2" value="${sellerobj.address2}">
					</div>
					<div class="form-group">
						<label>city : </label> <input type="text" class="form-control"
							placeholder="Enter city" name="city" value="${sellerobj.city}">
					</div>
					<div class="form-group">
						<label>State :</label> <input type="text" class="form-control"
							placeholder="Enter State Name" name="state"
							value="${sellerobj.state}">
					</div>
					<div class="form-group">
						<label>Zip :</label> <input type="text" class="form-control"
							placeholder="Enter Zip" name="zip" value="${sellerobj.zip}">
					</div>
					<div class="form-group">
						<label>Phone number:</label> <input type="text"
							class="form-control" placeholder="Enter Phone Number"
							name="phone" value="${sellerobj.phone}">
					</div>
					<div class="form-group">
						<label>Fax: </label> <input type="text" class="form-control"
							placeholder="Enter Fax" name="fax" value="${sellerobj.fax}">
					</div>
					<div class="form-group">
					...
					<c:if test="${mode=='MODE_NEW'}">
						<div class="form-group">
							<label>Re-enter Password:</label> <input type="text"
								class="form-control" id="zip" placeholder="Re-enter Password"
