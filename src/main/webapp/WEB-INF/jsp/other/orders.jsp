...
<body>
						...
						<tbody>
							<c:forEach var="orderList" items="${orderList}">
								<tr>
									...
									<td><a href="orders/${orderList.id}"><span
		...
		<c:when test="${mode == 'MODE_NEW' || mode == 'MODE_UPDATE'}">
			...
			<div class="container">
				...
				<form action="/saveorder" method="post"
					onreadystatechange="selectItemByValue()">
 ...
 --%>
					...
					<!-- 					</div> -->
					<div class="form-group">
						<b><label>Order Id: ${orderobj.id}</label></b> <input
							type="hidden" class="form-control" placeholder="Order Id"
							name="orderId" value="${orderobj.id}">
					</div>
					<div class="form-group">
						<b><label>Age : ${orderobj.age}</label></b> <input type="hidden"
							type="text" class="form-control" placeholder="Age" name="age"
							value="${orderobj.age}">
					</div>
					<div class="form-group">
						<label>Date : ${orderobj.date}</label> <input type="hidden"
							type="text" class="form-control" placeholder="Date" name="date"
							value="${orderobj.date}">
					</div>
					<div class="form-group">
		      ...
		      ${orderobj.details}
					...
					<div class="form-group">
						<b><label>User name : ${orderobj.orderUserName}</label></b> <input
							type="hidden" type="text" class="form-control"
							placeholder="orderUserName" name="orderUserName"
							value="${orderobj.orderUserName}">
					</div>
					<div class="form-group">
						<label>Status : </label>
 ...
 --%>
						...
						<select name="status">
							<c:forEach items="${status}" var="item">
								<option value="${item}"
									${item == selectedStatus ? 'selected' : ' '}>${item}</option>
								<!--  -->
							</c:forEach>
						</select>
